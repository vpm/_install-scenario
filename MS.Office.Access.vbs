...
filePath = strProgFiles & "\OfficeDeploymentTool\configuration-Access-x64.xml"
Set file = fso.CreateTextFile(filePath, True)

file.WriteLine "<Configuration>"
file.WriteLine " <Add OfficeClientEdition=""64"" Channel=""PerpetualVL2024"">"
file.WriteLine "  <Product ID=""Access2024Volume"">"
...
' install Access 
objShell.Run "powershell Start-Process -WindowStyle Minimized -Wait -WorkingDirectory ${env:ProgramFiles}\OfficeDeploymentTool -FilePath setup.exe -ArgumentList '/configure configuration-Access-x64.xml'", 2, true
